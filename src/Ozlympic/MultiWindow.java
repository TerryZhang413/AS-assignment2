...
class RunningGame implements EventHandler<ActionEvent> {
	...
	public void handle(ActionEvent e) {
		...
		try {
			...
			final Text official = new Text(100, 20,
					"Offical: " + driver.getOffName(games.get(driver.gameIDIndex).getOfficialID()));
			...
			final Text text1 = new Text(10, 140,
					driver.getAthleteInf(MultiWindow.games.get(driver.gameIDIndex).getAthletes().get(0))[0]);
			final Text text2 = new Text(10, 180,
					driver.getAthleteInf(MultiWindow.games.get(driver.gameIDIndex).getAthletes().get(1))[0]);
			final Text text3 = new Text(10, 220,
					driver.getAthleteInf(MultiWindow.games.get(driver.gameIDIndex).getAthletes().get(2))[0]);
			final Text text4 = new Text(10, 260,
					driver.getAthleteInf(MultiWindow.games.get(driver.gameIDIndex).getAthletes().get(3))[0]);
			final Text text5 = new Text(10, 300,
					driver.getAthleteInf(MultiWindow.games.get(driver.gameIDIndex).getAthletes().get(4))[0]);
			final Text text6 = new Text(10, 340,
					driver.getAthleteInf(MultiWindow.games.get(driver.gameIDIndex).getAthletes().get(5))[0]);
			final Text text7 = new Text(10, 380,
					driver.getAthleteInf(MultiWindow.games.get(driver.gameIDIndex).getAthletes().get(6))[0]);
			final Text text8 = new Text(10, 420,
					driver.getAthleteInf(MultiWindow.games.get(driver.gameIDIndex).getAthletes().get(7))[0]);
			...
			final ImageView runner = new ImageView(new Image("image/runner.png"));
			...
			border.getChildren().addAll(official, gameName, gameID, text1, text2, text3, text4, text5, text6, text7,
					text8, endLine, startLine);
			...
			final KeyFrame kf1 = new KeyFrame(
					Duration.millis(coefficient * 1000 * games.get(driver.gameIDIndex).getResults().get(0)), kv1);
			final KeyFrame kf2 = new KeyFrame(
					Duration.millis(coefficient * 1000 * games.get(driver.gameIDIndex).getResults().get(1)), kv2);
			final KeyFrame kf3 = new KeyFrame(
					Duration.millis(coefficient * 1000 * games.get(driver.gameIDIndex).getResults().get(2)), kv3);
			final KeyFrame kf4 = new KeyFrame(
					Duration.millis(coefficient * 1000 * games.get(driver.gameIDIndex).getResults().get(3)), kv4);
			final KeyFrame kf5 = new KeyFrame(
					Duration.millis(coefficient * 1000 * games.get(driver.gameIDIndex).getResults().get(4)), kv5);
			final KeyFrame kf6 = new KeyFrame(
					Duration.millis(coefficient * 1000 * games.get(driver.gameIDIndex).getResults().get(5)), kv6);
			final KeyFrame kf7 = new KeyFrame(
					Duration.millis(coefficient * 1000 * games.get(driver.gameIDIndex).getResults().get(6)), kv7);
			final KeyFrame kf8 = new KeyFrame(
					Duration.millis(coefficient * 1000 * games.get(driver.gameIDIndex).getResults().get(7)), kv8);
			...
			/*
			 * timeline.getKeyFrames().addAll( new KeyFrame(new Duration(14000)
			 * // set start position at 0 ,kv10 ), new KeyFrame(new
			 * Duration(15000), // set end position at 40s kv9));
			 */
...
class ShowResult implements EventHandler<ActionEvent> {
	...
	public void handle(ActionEvent event) {
		...
		final Text OfficalName = new Text(
				"OfficalName: " + driver.getOffName(MultiWindow.games.get(driver.gameIDIndex).getOfficialID()));
		final Text Name = new Text("Name");
		final Text Age = new Text("Age");
		final Text State = new Text("State");
		final Text AthleteType = new Text("Athlete Type");
